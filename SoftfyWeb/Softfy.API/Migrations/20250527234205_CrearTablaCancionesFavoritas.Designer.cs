...
namespace SoftfyWeb.Migrations
{
    ...
    [Migration("20250527234205_CrearTablaCancionesFavoritas")]
    partial class CrearTablaCancionesFavoritas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoftfyWeb.Modelos.Artista", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SoftfyWeb.Modelos.Cancion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SoftfyWeb.Modelos.CancionFavorita", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SoftfyWeb.Modelos.PlaylistCancion", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SoftfyWeb.Modelos.Usuario", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SoftfyWeb.Modelos.Cancion", b =>
                {
                    b.HasOne("SoftfyWeb.Modelos.Artista", "Artista")
                        .WithMany()
            ...
            modelBuilder.Entity("SoftfyWeb.Modelos.CancionFavorita", b =>
                {
                    b.HasOne("SoftfyWeb.Modelos.Cancion", "Cancion")
                        .WithMany()
            ...
            modelBuilder.Entity("SoftfyWeb.Modelos.PlaylistCancion", b =>
                {
                    ...
                    b.HasOne("SoftfyWeb.Modelos.Playlist", "Playlist")
